	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarNav" style="padding-left: 20px;">
			<ul class="navbar-nav">
				...
				<li class="nav-item" style="padding-left: 20px;">
					<a class="nav-link" href="{{url('/writing')}}">MY WRITING</a>
				</li>
				<li class="nav-item" style="padding-left: 20px;">
				...
				<li class="nav-item" style="padding-left: 20px;">
					<a class="nav-link" href="https://www.instagram.com/sarah.00.samei?igsh=MmVlMjlkMTBhMg==">
				...
				<li>
					<a class="nav-link" href="https://github.com/sarah-samei">
				...
				<li>
					<a class="nav-link" href="#">
						<svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-brightness-low-fill" viewBox="0 0 16 16">
				...
				<li>
					<a class="nav-link" href="#">
						<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-moon-stars-fill" viewBox="0 0 16 16">
